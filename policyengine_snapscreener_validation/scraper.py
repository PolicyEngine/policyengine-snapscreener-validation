...
class SNAPScreenerScraper:
    ...
    def _run_calculation(self, page: Page, household: SNAPHousehold) -> Optional[Dict]:
    ...
    def _fill_form(self, page: Page, household: SNAPHousehold) -> bool:
        ...
        try:
            ...
            start_buttons = ["Get Started", "Start", "Begin", "Check Eligibility"]
            ...
            radio_buttons = page.locator('input[type="radio"][value="false"]').all()
    ...
    def _get_results(self, page: Page) -> Optional[Dict]:
        ...
        try:
            ...
            if "not eligible" in page_text.lower() or "ineligible" in page_text.lower():
                return {
                    "benefit_amount": 0,
                    "is_eligible": False,
                    "source": "snapscreener.com",
