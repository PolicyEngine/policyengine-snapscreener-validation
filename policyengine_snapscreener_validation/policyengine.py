...
class PolicyEngineCalculator:
    ...
    def calculate(
        ...
        snap_standard_deduction = sim.calculate("snap_standard_deduction", year)[0]
        snap_earned_income_deduction = sim.calculate(
            "snap_earned_income_deduction", year
        )[0]
        snap_utility_allowance = sim.calculate("snap_utility_allowance", year)[0]
        ...
        # Check eligibility
        meets_gross_test = sim.calculate("meets_snap_gross_income_test", year)[0]
        ...
        return {
            ...
            "excess_shelter_deduction": snap_excess_shelter_expense_deduction / 12,
