...
class TestSNAPValidator:
    ...
    def test_validate_single_with_tanf(self):
        ...
        if result_with_tanf["tanf_included"]:
            assert result_with_tanf["policyengine_benefit"] < result_without_tanf["policyengine_benefit"]
    ...
    def test_validate_single_with_sua(self):
        ...
        assert result_with_sua["policyengine_benefit"] >= result_without_sua["policyengine_benefit"]
