...
class TestPolicyEngineCalculator:
    ...
    def test_tanf_inclusion(self):
        ...
        result_without = self.calculator.calculate(household, include_tanf=False)
    ...
    def test_sua_trigger(self):
        ...
        result_without = self.calculator.calculate(household, trigger_sua=False)
        result_with = self.calculator.calculate(household, trigger_sua=True)
        
        # Utility allowance should be higher with SUA
        assert result_with["utility_allowance"] >= result_without["utility_allowance"]
